...
Версия [таблицы инструкций компьютера Аркадия Чубрика](https://github.com/chubrik/LogicArrows/blob/main/ru/computer-v2/programming.md), расположенная как в архитектуре моего будущего процессора
<br>

## Инструкции, отличающиеся от архитектуры Аркадия

Инструкция | Описание | Пример кода/<br>влияние на флаги
---|---|---
wai | Останавливает выполнение программы, после повторного нажатия кнопки **RUN**
...
### Описание остальных инструкций соответствует описанию на [репозитории Аркадия](https://github.com/chubrik/LogicArrows/blob/main/ru/computer-v2/programming.md)
